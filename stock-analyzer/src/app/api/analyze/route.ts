...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const fund = {
      ...
      pcf: fin.operatingCashflow && detail.marketCap ? detail.marketCap / fin.operatingCashflow : null,
      pfcf: fin.freeCashflow && detail.marketCap ? detail.marketCap / fin.freeCashflow : null,
      ...
      operating_cash_flow: fin.operatingCashflow ?? null,
